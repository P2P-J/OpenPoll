...
import type { VoteOption, VoteState } from "@/types/balanceDetail.types";
...
export function BalanceVotePanel({
  isLoggedIn,
  isVoting,
  selectedOption,
  agreeCountView,
      ...
      <div className="relative">
        ...
        <div className="text-center py-4 mt-6 border-t border-white/10">
          <p className="text-gray-400">
            총 <span className="font-bold text-white text-lg">{totalVotesSafe.toLocaleString()}명</span>이 참여했습니다
          </p>
        </div>
      </div>
    </motion.div>
