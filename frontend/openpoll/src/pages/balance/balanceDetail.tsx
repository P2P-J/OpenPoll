...
import { BalanceDetailHero } from "@/components/balance/BalanceDetailHero";
import { BalanceVotePanel } from "@/components/balance/BalanceVotePanel";
import { BalanceCommentSection } from "@/components/balance/BalanceCommentSection";
...
export function BalanceDetail() {
  ...
  const isMyComment = (c: BalanceCommentNodeModel) => {
  ...
  const countAllComments = (nodes: BalanceCommentNodeModel[]) => {
    let count = 0;
